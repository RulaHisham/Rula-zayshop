        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="{{route('dashboard.index')}}" @class(['nav-link','active'=> request()->routeIs('dashboard.index')])>
              ...
              <li class="nav-item menu-open">
            <a href="{{route('dashboard.categories.index')}}" @class(['nav-link','active'=> request()->routeIs('dashboard.categories.index')]) ">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
               Categories
              </p>
               ...
               <li class="nav-item menu-open">
            <a href="{{route('dashboard.products.index')}}" @class(['nav-link','active'=>request()->routeIs('dashboard.products.index')]) ">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Products
